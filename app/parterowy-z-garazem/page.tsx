...
export const metadata = {
  ...
  description:
    'Sprawdź nasze domy parterowe z garażem. Budujemy od fundamentów po stan deweloperski na Śląsku.',
}
      ...
      <div className="max-w-6xl mx-auto px-4 pt-32 pb-16">
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-500 text-sm max-w-xl leading-relaxed mx-auto">
            Wygodne miejsce dla auta zintegrowane z bryłą domu. Wybierz projekt
            dopasowany do swoich potrzeb.
          </p>
        </div>
        <ProjectGrid projects={withGarage} />
      </div>
    </div>
  )
}
