...
export default function Home() {
  ...
  return (
    <div>
      <style>{`
        nav {
          background: ${scrolled ? 'rgba(255,255,255,0.88)' : 'transparent'} !important;
      ...
      <section className="relative w-full h-screen min-h-[700px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end px-4 pb-16 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-medium text-white leading-tight max-w-3xl mb-4">
            Domy parterowe budowane z pasją
          </h1>
          <p className="text-white/70 text-base max-w-lg mb-12 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-3xl">
            <Link
              ...
              className="group relative overflow-hidden rounded-2xl border border-white/20 hover:border-white/50 transition-all duration-300"
            >
              <div className="relative h-64">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 text-left">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-white/50 group-hover:text-white transition-colors text-lg">
                      →
                    </span>
                  </div>
                </div>
      ...
      <section className="bg-white max-w-3xl mx-auto px-4 py-20">
        ...
        <div className="space-y-4 text-sm text-gray-500 leading-relaxed">
          <p>
            ...
            prosty, a ogród staje się częścią wnętrza, skontaktuj się z nami już
            dziś.
          </p>
          <p>
          ...
          <p>
            ...
            piętrowy o tej samej wielkości — mniej betonu pod fundamenty i
            łatwiejszy dach to realna oszczędność.
          </p>
        </div>
      </section>
    </div>
