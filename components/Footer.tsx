    ...
    <footer className="bg-white border-t border-gray-100 text-gray-400">
      <div className="max-w-6xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="md:col-span-1">
          ...
          <p className="text-sm leading-relaxed text-gray-400">
            Firma ogólnobudowlana S-BUD. Budujemy domy parterowe od fundamentów
            po stan deweloperski na Śląsku.
          </p>
        </div>

        <div>
          <h3 className="text-gray-900 text-xs font-semibold mb-5 uppercase tracking-wider">
            Oferta
          </h3>
        ...
        <div>
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-xl px-4 py-3 text-sm text-gray-700"
          >
      ...
      <div className="border-t border-gray-100 py-6">
        <div className="max-w-6xl mx-auto px-4 flex flex-col gap-3">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2 text-xs text-gray-400">
            <span>
              © {new Date().getFullYear()} S-BUD Krzysztof Skibiński Firma
              Ogólnobudowlana. Wszelkie prawa zastrzeżone.
            </span>
            <Link
              href="/rodo"
